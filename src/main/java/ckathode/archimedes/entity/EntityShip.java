...
import ckathode.archimedes.chunk.*;
...
public class EntityShip extends EntityBoat implements IEntityAdditionalSpawnData {
    ...
    protected void handleServerUpdate(double horvel) {
        ...
        boolean bool = handleCollision(posX, posY, posZ);
    }
    ...
    /**
     * Used for very quick movement. Where collisions would otherwise not be called.
     *
     * @param x
     * @param y
     * @param z
     * @return
     */
    public boolean canShipMoveTo(int x, int y, int z) {
        return handleCollision(x, y, z);
    }

    /**
     * Aligns to the closest anchor within 10 blocks.
     *
     * @return
     */
