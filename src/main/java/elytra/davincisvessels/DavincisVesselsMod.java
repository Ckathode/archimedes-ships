...
public class DavincisVesselsMod {
    ...
    public static final String MOD_GUIFACTORY = "elytra.davincisvessels.client.gui.DavincisVesselsGUIFactory";
    ...
    @SidedProxy(clientSide = "elytra.davincisvessels.client.ClientProxy", serverSide = "elytra.davincisvessels.common.CommonProxy")
